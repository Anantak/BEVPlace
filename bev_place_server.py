...
parser.add_argument('--listenPort', type=int, default=51705, help='port to use for listening')
parser.add_argument('--publishPort', type=int, default=51706, help='port to use for listening')
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--file", help="protoc filename to parse", type=str, default='')
    # parser.add_argument("--live_map_num", help="number of the live map", type=int, default=-1)
