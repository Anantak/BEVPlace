...
_TRACTIONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='traction_encoder_value', full_name='anantak.message.TractionMessage.traction_encoder_value', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='command', full_name='anantak.message.TractionMessage.command', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='error_code', full_name='anantak.message.TractionMessage.error_code', index=13,
      number=100, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
TractionMessage = _reflection.GeneratedProtocolMessageType('TractionMessage', (_message.Message,), dict(
