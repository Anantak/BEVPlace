...
_SENSORMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='environment_msg', full_name='anantak.message.SensorMsg.environment_msg', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='map_request_msg', full_name='anantak.message.SensorMsg.map_request_msg', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='file_msg', full_name='anantak.message.SensorMsg.file_msg', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='errors_request_msg', full_name='anantak.message.SensorMsg.errors_request_msg', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_states_msg', full_name='anantak.message.SensorMsg.machine_states_msg', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fleet_manager_state_msg', full_name='anantak.message.SensorMsg.fleet_manager_state_msg', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reporter_database_msg', full_name='anantak.message.SensorMsg.reporter_database_msg', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_readings_msg', full_name='anantak.message.SensorMsg.machine_readings_msg', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='diagnoser_msg', full_name='anantak.message.SensorMsg.diagnoser_msg', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='jira_message', full_name='anantak.message.SensorMsg.jira_message', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='jira_request_message', full_name='anantak.message.SensorMsg.jira_request_message', index=25,
...
HeaderMsg = _reflection.GeneratedProtocolMessageType('HeaderMsg', (_message.Message,), dict(
